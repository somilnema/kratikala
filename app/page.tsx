    ...
    <div className="flex flex-col min-h-screen cursor-paint-brush">
      ...
      >
        ...
        <div className="absolute top-10 sm:top-20 left-[5%] sm:left-[10%] animate-float-slow">
          <div className="w-16 h-16 rounded-full blur-xl sm:w-20 sm:h-20 bg-fuchsia-300/70" />
        </div>
        <div className="absolute bottom-10 sm:bottom-20 right-[10%] sm:right-[15%] animate-float">
          <div className="w-24 h-24 rounded-full blur-xl sm:w-32 sm:h-32 bg-cyan-300/70" />
        </div>
        <div className="absolute top-1/4 sm:top-1/3 right-[15%] sm:right-[20%] animate-float-slow-reverse">
          <div className="w-20 h-20 rounded-full blur-xl sm:w-24 sm:h-24 bg-yellow-300/70" />
        </div>
        ...
        <div className="container relative z-10 px-4 sm:px-6 md:px-8">
          <div className="grid gap-6 items-center lg:grid-cols-2 lg:gap-12">
            ...
            >
              <Badge className="mx-auto mb-2 bg-fuchsia-500 w-fit lg:mx-0 hover:bg-fuchsia-600 animate-pulse-slow">
                Artistic Creations
              </Badge>
              ...
              <div className="flex flex-col gap-2 justify-center pt-4 sm:flex-row lg:justify-start">
            ...
            >
              <div className="grid grid-cols-2 gap-2 transition-all duration-500 transform rotate-2 sm:gap-4 md:gap-6 lg:gap-8 hover:rotate-0">
                <div className="grid gap-2 sm:gap-4 md:gap-6 lg:gap-8">
                  <div className="overflow-hidden rounded-2xl shadow-xl transition-all duration-300 transform hover:shadow-2xl hover:-translate-y-1 animated-border animate-canvas-reveal">
                    <Image
                      alt="Painting 1"
                  ...
                  <div className="overflow-hidden rounded-2xl shadow-xl transition-all duration-300 transform hover:shadow-2xl hover:-translate-y-1 animated-border animate-canvas-reveal animate-delay-300">
                    <Image
                      alt="Painting 2"
                      className="aspect-[4/5] overflow-hidden rounded-2xl object-cover hover:scale-105 transition-all duration-500 canvas-texture"
                      height={300}
                ...
                <div className="grid gap-2 transform translate-y-4 sm:gap-4 md:gap-6 lg:gap-8 sm:translate-y-6">
                  <div className="overflow-hidden rounded-2xl shadow-xl transition-all duration-300 transform hover:shadow-2xl hover:-translate-y-1 animated-border animate-canvas-reveal animate-delay-200">
                    <Image
                      alt="Painting 3"
                      className="aspect-[4/5] overflow-hidden rounded-2xl object-cover hover:scale-105 transition-all duration-500 canvas-texture"
                      height={300}
                  ...
                  <div className="overflow-hidden rounded-2xl shadow-xl transition-all duration-300 transform hover:shadow-2xl hover:-translate-y-1 animated-border animate-canvas-reveal animate-delay-500">
                    <Image
                      alt="Painting 4"
                      className="aspect-[4/5] overflow-hidden rounded-2xl object-cover hover:scale-105 transition-all duration-500 canvas-texture"
                      height={300}
      ...
      <section
        ref={featuredRef}
        className="overflow-hidden relative py-12 w-full bg-gradient-to-b from-white to-fuchsia-50 md:py-24 lg:py-32"
      >
        ...
        <div className="container relative z-10 px-4 md:px-6">
          ...
          >
            ...
            <div className="space-y-2">
              <h2 className="inline-block relative text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl brush-stroke">
                Featured Paintings
          ...
          <div className="grid grid-cols-1 gap-8 py-12 mx-auto max-w-5xl sm:grid-cols-2 md:grid-cols-3 lg:gap-12">
      ...
      {/* Custom Orders */}
      <section ref={customRef} className="overflow-hidden relative py-12 w-full md:py-24 lg:py-32 animated-bg">
        <div className="absolute inset-0 bg-gradient-to-tr from-yellow-100 to-cyan-100 opacity-70 animate-color-mix" />
        <div className="absolute inset-0 bg-[url('/placeholder.svg')] mix-blend-overlay opacity-10" />

        {/* Decorative elements */}
        <div className="absolute left-10 top-1/4 w-40 h-40 rounded-full border-4 border-yellow-300 border-dashed opacity-50 animate-spin-slow" />
        <div className="absolute right-10 bottom-1/4 w-32 h-32 rounded-full border-4 border-cyan-300 border-dashed opacity-50 animate-spin-slow-reverse" />
          ...
          <div className="grid gap-6 items-center lg:grid-cols-2 lg:gap-12">
            ...
            >
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-fuchsia-400 to-yellow-400 rounded-xl opacity-30 blur-xl animate-pulse-slow" />
                <Image
            ...
            >
              <Badge className="mb-2 bg-cyan-500 w-fit hover:bg-cyan-600 animate-pulse-slow">Personalized Art</Badge>
              <div className="space-y-2">
              ...
              <ul className="grid gap-3 py-4">
                <li className="flex gap-2 items-center animate-fade-in-right animate-delay-400">
                  <div className="flex justify-center items-center w-8 h-8 text-white bg-gradient-to-br from-fuchsia-500 to-yellow-500 rounded-full shadow-lg animate-pulse-slow">
                    <CheckIcon className="w-4 h-4" />
                  </div>
                  <span className="font-medium">Portraits from your photos</span>
                </li>
                <li className="flex gap-2 items-center animate-fade-in-right animate-delay-500">
                  <div className="flex justify-center items-center w-8 h-8 text-white bg-gradient-to-br from-yellow-500 to-cyan-500 rounded-full shadow-lg animate-pulse-slow">
                    <CheckIcon className="w-4 h-4" />
                  </div>
                  <span className="font-medium">Custom landscapes and scenery</span>
                </li>
                <li className="flex gap-2 items-center animate-fade-in-right animate-delay-600">
                  <div className="flex justify-center items-center w-8 h-8 text-white bg-gradient-to-br from-cyan-500 to-fuchsia-500 rounded-full shadow-lg animate-pulse-slow">
                    <CheckIcon className="w-4 h-4" />
                  </div>
